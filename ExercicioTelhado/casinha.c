...
static GLubyte piradeFrente[]     = {0,2,10};
static GLubyte piradeEsquerda[]   = {5,0,10};
static GLubyte piradeDireita[]    = {2,6,10};
static GLubyte piradeTras[]       = {6,5,10};
...
void display(void){
  ...
  glColor3f (LARANJA); /* fundo - amarelo escuro*/
  ...
  glDrawElements(GL_TRIANGLES, 3, GL_UNSIGNED_BYTE, piradeFrente);
 
  glColor3f (VERMELHO); /* esquerda */
  glDrawElements(GL_TRIANGLES, 3, GL_UNSIGNED_BYTE, piradeEsquerda);
 
  glColor3f (AMARELO); /* direita*/
  glDrawElements(GL_TRIANGLES, 3, GL_UNSIGNED_BYTE, piradeDireita);
 
  glColor3f (AZUL); /* tras - ta certo ate agora*/
  glDrawElements(GL_TRIANGLES, 3, GL_UNSIGNED_BYTE, piradeTras);
